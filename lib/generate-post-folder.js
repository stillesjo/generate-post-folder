...
export default {
  ...
  activate(state) {
    ...
    this.generatePostFolderView.getInputElements().forEach(e => e.addEventListener('blur', blurHandler))
    this.subscriptions = new CompositeDisposable({
      dispose: () => this.generatePostFolderView.getInputElements.forEach(e => e.removeEventListener(blurHandler))
    });
    ...
    atom.commands.add(this.generatePostFolderView.getElement(), {
      'core:confirm': () => this.modalPanel.hide(),
